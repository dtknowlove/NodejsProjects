...
namespace PTGame.ModuleUpdate
{
	...
	/// </summary>
	public class PTModuleUpdateDispatcher : MonoBehaviour
	{
		...
		private static PTModuleUpdateDispatcher _instance = null;
		...
		public static PTModuleUpdateDispatcher Instance()
		{
			if (!Exists())
			{
				throw new Exception(
