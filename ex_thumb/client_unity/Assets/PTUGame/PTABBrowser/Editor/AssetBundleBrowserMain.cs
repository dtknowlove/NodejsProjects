...
namespace AssetBundleBrowser
{
    ...
    public class AssetBundleBrowserMain : EditorWindow, IHasCustomMenu, ISerializationCallbackReceiver
    {
        ...
        internal static AssetBundleBrowserMain instance
        {
            ...
            {
                if (s_instance == null)
                    s_instance = GetWindow(typeof(AssetBundleBrowserMain), true,"AssetBundles",true) as AssetBundleBrowserMain;
                return s_instance;
            }
        }
        ...
        [SerializeField]
        internal AssetFileManageTab m_FileTab;
        ...
        [MenuItem("PuTaoTool/ResKit/AB Browser", priority = 2050)]
        ...
        private void OnEnable()
        {
            ...
            if(m_FileTab == null)
                m_FileTab = new AssetFileManageTab();
            m_FileTab.OnEnable(this);
            if(m_BuildTab == null)
        ...
        void ModeToggle()
        {
            ...
            string[] labels = new string[4] { "Configure", "Build", "Inspect" ,"FileMgr"};
