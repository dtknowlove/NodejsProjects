...
namespace PTGame.Core
{
	...
	public class Matrix
	{
		...
		{
			var sin = Mathf.Sin(rotationInRadians);
			var cos = Mathf.Cos(rotationInRadians);
		...
		{
			var newVector = GetNewTransformedVector(new UnityEngine.Vector2(0, 1));
		...
		{
			var bottom = 1.0f / (other.a * other.d - other.b * other.c);
